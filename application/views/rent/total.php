<table id="report-table" class="table hotel-table" style="margin-bottom: 0px;">
    ...
    <?php if (isset($data['notes']) && $data['notes']): ?>
        <tr>
            <td colspan="3" style="color: red;"><h5><b><?php echo ((isset($data['negotiate_price']) && $data['negotiate_price']) ? ('Thuê phòng thỏa thuận ' . number_format($data['negotiate_price'], 0) . '; ') : '') . $data['notes']; ?></b></h5></td>
        </tr>
	<?php endif; ?>
</table>